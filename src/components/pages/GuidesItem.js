        ...
        return (
            ...
            {this.props.guides.map((guide) => (
                <div className="col-sm-4 mb-4" key={ guide.secondText }>
                    <a href={ guide.articleLink } target="_blank" rel="noopener noreferrer"><img src={ process.env.PUBLIC_URL + guide.imgLink } style={{ height:"352px", width:"100%" }} alt={ guide.firstText }></img></a>
