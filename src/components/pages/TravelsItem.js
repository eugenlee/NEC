    ...
    getContinents(continent)  {
        return this.props.travels.map((travel) => (
            ...
            <div className="col-sm-3 mb-4" key={ travel.city }>
                <a href={ travel.link }><img src={ process.env.PUBLIC_URL + travel.image } style={{ height:"240px", width:"100%" }} alt={ travel.city }></img></a>
                <span id="cities"><a href={ travel.link }>{ travel.city }</a></span>
